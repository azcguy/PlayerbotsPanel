...
function PlayerbotsPanel:SetupGearFrame()
    ...
    gearView.iconCopper:SetPoint("TOPLEFT", PlayerbotsGear, 100, moneyposY)
    gearView.iconCopper:SetTexture("Interface\\MONEYFRAME\\UI-CopperIcon.blp")
    gearView.iconCopper:SetSize(12, 12)

    gearView.txtCopper = PlayerbotsGear:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    gearView.txtCopper:SetPoint("TOPLEFT", PlayerbotsGear, 111, moneyposY)
    gearView.txtCopper:SetJustifyH("LEFT")
    gearView.txtCopper:SetSize(20, 12)
    gearView.txtCopper:SetText("99")

    gearView.iconSilver = PlayerbotsGear:CreateTexture(nil, "OVERLAY")
    gearView.iconSilver:SetPoint("TOPLEFT", PlayerbotsGear, 127, moneyposY)
    gearView.iconSilver:SetTexture("Interface\\MONEYFRAME\\UI-SilverIcon.blp")
    gearView.iconSilver:SetSize(12, 12)

    gearView.txtSilver = PlayerbotsGear:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    gearView.txtSilver:SetPoint("TOPLEFT", PlayerbotsGear, 137, moneyposY)
    gearView.txtSilver:SetJustifyH("LEFT")
    gearView.txtSilver:SetSize(20, 12)
    gearView.txtSilver:SetText("99")

    gearView.iconGold = PlayerbotsGear:CreateTexture(nil, "OVERLAY")
    gearView.iconGold:SetPoint("TOPLEFT", PlayerbotsGear, 155, moneyposY)
    gearView.iconGold:SetTexture("Interface\\MONEYFRAME\\UI-GoldIcon.blp")
    gearView.iconGold:SetSize(12, 12)

    gearView.txtGold = PlayerbotsGear:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    gearView.txtGold:SetPoint("TOPLEFT", PlayerbotsGear, 165, moneyposY)
    gearView.txtGold:SetJustifyH("LEFT")
    gearView.txtGold:SetSize(40, 12)
